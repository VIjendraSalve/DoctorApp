 ...
 */
public abstract class UtilityRuntimePermissionAbstract extends AppCompatActivity {
    //private SparseIntArray mErrorString;
    private boolean result=false;
    int permissionCheck;
    final String[] requestedPermissions=new String[]{Manifest.permission.GET_ACCOUNTS,
